...
| **3B** | Commercial funnel | **3B.1 IMPLEMENTED LOCALLY, owner visual review required** (2026-09-25; [PHASE_3B_REPORT.md](PHASE_3B_REPORT.md)): the read-only Funil comercial from the local CRM through one adapter, and the deal stage-transition ledger. Moved ahead of memory and RAG by owner decision Q (sequencing only) |
...
### Phase 3B.1 — commercial funnel and funnel intelligence (2026-09-25) — IMPLEMENTED LOCALLY, OWNER VISUAL REVIEW REQUIRED
...
- **Next:** the owner's visual review, then the single remote integration cycle. Commercial authority in Company OS is a separate owner decision.
