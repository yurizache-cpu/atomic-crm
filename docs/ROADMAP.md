...
| **3B** | Commercial funnel | **3B.1 IMPLEMENTED, owner visual review PASS** (2026-09-25; [PHASE_3B_REPORT.md](PHASE_3B_REPORT.md)): the read-only Funil comercial from the local CRM through one adapter, and the deal stage-transition ledger. Moved ahead of memory and RAG by owner decision Q (sequencing only) |
